...
/**
 * Initializes the playback device configuration based on the decoder's output
 * format, channels, and sample rate.
 *
 * @param dw_sdata Pointer to the DuckWaveSoundData structure which holds the
 * decoder and device configuration.
 */
...
/**
 * Starts the audio playback on a separate thread using the initialized device
 * and decoder.
 *
 * @param dw_sdata Pointer to the DuckWaveSoundData structure which holds the
 * decoder and device configuration.
