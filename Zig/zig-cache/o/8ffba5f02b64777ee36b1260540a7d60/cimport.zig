...
pub const uint_8 = u8;
pub const uint_16 = c_ushort;
pub const uint_32 = c_uint;
pub const sint_8 = i8;
pub const sint_16 = c_short;
pub const sint_32 = c_int;
pub const struct_ao_info = extern struct {
    type: c_int,
    name: [*c]u8,
    short_name: [*c]u8,
    author: [*c]u8,
...
pub const ao_info = struct_ao_info;
pub const struct_ao_functions = opaque {};
pub const ao_functions = struct_ao_functions;
pub const struct_ao_device = opaque {};
pub const ao_device = struct_ao_device;
pub const struct_ao_sample_format = extern struct {
    bits: c_int,
    rate: c_int,
    channels: c_int,
    byte_format: c_int,
...
pub const ao_sample_format = struct_ao_sample_format;
pub const struct_ao_option = extern struct {
    key: [*c]u8,
    value: [*c]u8,
    next: [*c]struct_ao_option,
};
pub const ao_option = struct_ao_option;
pub extern fn ao_initialize() void;
pub extern fn ao_shutdown() void;
pub extern fn ao_append_global_option(key: [*c]const u8, value: [*c]const u8) c_int;
pub extern fn ao_append_option(options: [*c][*c]ao_option, key: [*c]const u8, value: [*c]const u8) c_int;
pub extern fn ao_free_options(options: [*c]ao_option) void;
pub extern fn ao_open_live(driver_id: c_int, format: [*c]ao_sample_format, option: [*c]ao_option) ?*ao_device;
pub extern fn ao_open_file(driver_id: c_int, filename: [*c]const u8, overwrite: c_int, format: [*c]ao_sample_format, option: [*c]ao_option) ?*ao_device;
pub extern fn ao_play(device: ?*ao_device, output_samples: [*c]u8, num_bytes: uint_32) c_int;
pub extern fn ao_close(device: ?*ao_device) c_int;
pub extern fn ao_driver_id(short_name: [*c]const u8) c_int;
pub extern fn ao_default_driver_id() c_int;
pub extern fn ao_driver_info(driver_id: c_int) [*c]ao_info;
pub extern fn ao_driver_info_list(driver_count: [*c]c_int) [*c][*c]ao_info;
pub extern fn ao_file_extension(driver_id: c_int) [*c]const u8;
pub extern fn ao_is_big_endian() c_int;
pub const MPG123_ENC_8: c_int = 15;
pub const MPG123_ENC_16: c_int = 64;
pub const MPG123_ENC_24: c_int = 16384;
pub const MPG123_ENC_32: c_int = 256;
pub const MPG123_ENC_SIGNED: c_int = 128;
pub const MPG123_ENC_FLOAT: c_int = 3584;
pub const MPG123_ENC_SIGNED_16: c_int = 208;
pub const MPG123_ENC_UNSIGNED_16: c_int = 96;
pub const MPG123_ENC_UNSIGNED_8: c_int = 1;
pub const MPG123_ENC_SIGNED_8: c_int = 130;
pub const MPG123_ENC_ULAW_8: c_int = 4;
pub const MPG123_ENC_ALAW_8: c_int = 8;
pub const MPG123_ENC_SIGNED_32: c_int = 4480;
pub const MPG123_ENC_UNSIGNED_32: c_int = 8448;
pub const MPG123_ENC_SIGNED_24: c_int = 20608;
pub const MPG123_ENC_UNSIGNED_24: c_int = 24576;
pub const MPG123_ENC_FLOAT_32: c_int = 512;
pub const MPG123_ENC_FLOAT_64: c_int = 1024;
pub const MPG123_ENC_ANY: c_int = 30719;
pub const enum_mpg123_enc_enum = c_uint;
...
pub const mpg123_ssize_t = isize;
pub const struct_mpg123_handle_struct = opaque {};
pub const mpg123_handle = struct_mpg123_handle_struct;
pub extern fn mpg123_distversion(major: [*c]c_uint, minor: [*c]c_uint, patch: [*c]c_uint) [*c]const u8;
pub extern fn mpg123_libversion(patch: [*c]c_uint) c_uint;
pub extern fn mpg123_init() c_int;
pub extern fn mpg123_exit() void;
pub extern fn mpg123_new(decoder: [*c]const u8, @"error": [*c]c_int) ?*mpg123_handle;
pub extern fn mpg123_delete(mh: ?*mpg123_handle) void;
pub extern fn mpg123_free(ptr: ?*anyopaque) void;
pub const MPG123_VERBOSE: c_int = 0;
pub const MPG123_FLAGS: c_int = 1;
pub const MPG123_ADD_FLAGS: c_int = 2;
pub const MPG123_FORCE_RATE: c_int = 3;
pub const MPG123_DOWN_SAMPLE: c_int = 4;
pub const MPG123_RVA: c_int = 5;
pub const MPG123_DOWNSPEED: c_int = 6;
pub const MPG123_UPSPEED: c_int = 7;
pub const MPG123_START_FRAME: c_int = 8;
pub const MPG123_DECODE_FRAMES: c_int = 9;
pub const MPG123_ICY_INTERVAL: c_int = 10;
pub const MPG123_OUTSCALE: c_int = 11;
pub const MPG123_TIMEOUT: c_int = 12;
pub const MPG123_REMOVE_FLAGS: c_int = 13;
pub const MPG123_RESYNC_LIMIT: c_int = 14;
pub const MPG123_INDEX_SIZE: c_int = 15;
pub const MPG123_PREFRAMES: c_int = 16;
pub const MPG123_FEEDPOOL: c_int = 17;
pub const MPG123_FEEDBUFFER: c_int = 18;
pub const MPG123_FREEFORMAT_SIZE: c_int = 19;
pub const enum_mpg123_parms = c_uint;
pub const MPG123_FORCE_MONO: c_int = 7;
pub const MPG123_MONO_LEFT: c_int = 1;
pub const MPG123_MONO_RIGHT: c_int = 2;
pub const MPG123_MONO_MIX: c_int = 4;
pub const MPG123_FORCE_STEREO: c_int = 8;
pub const MPG123_FORCE_8BIT: c_int = 16;
pub const MPG123_QUIET: c_int = 32;
pub const MPG123_GAPLESS: c_int = 64;
pub const MPG123_NO_RESYNC: c_int = 128;
pub const MPG123_SEEKBUFFER: c_int = 256;
pub const MPG123_FUZZY: c_int = 512;
pub const MPG123_FORCE_FLOAT: c_int = 1024;
pub const MPG123_PLAIN_ID3TEXT: c_int = 2048;
pub const MPG123_IGNORE_STREAMLENGTH: c_int = 4096;
pub const MPG123_SKIP_ID3V2: c_int = 8192;
pub const MPG123_IGNORE_INFOFRAME: c_int = 16384;
pub const MPG123_AUTO_RESAMPLE: c_int = 32768;
pub const MPG123_PICTURE: c_int = 65536;
pub const MPG123_NO_PEEK_END: c_int = 131072;
pub const MPG123_FORCE_SEEKABLE: c_int = 262144;
pub const MPG123_STORE_RAW_ID3: c_int = 524288;
pub const MPG123_FORCE_ENDIAN: c_int = 1048576;
pub const MPG123_BIG_ENDIAN: c_int = 2097152;
pub const MPG123_NO_READAHEAD: c_int = 4194304;
pub const MPG123_FLOAT_FALLBACK: c_int = 8388608;
pub const MPG123_NO_FRANKENSTEIN: c_int = 16777216;
pub const enum_mpg123_param_flags = c_uint;
pub const MPG123_RVA_OFF: c_int = 0;
pub const MPG123_RVA_MIX: c_int = 1;
pub const MPG123_RVA_ALBUM: c_int = 2;
pub const MPG123_RVA_MAX: c_int = 2;
pub const enum_mpg123_param_rva = c_uint;
pub extern fn mpg123_param2(mh: ?*mpg123_handle, @"type": c_int, value: c_long, fvalue: f64) c_int;
pub extern fn mpg123_getparam2(mh: ?*mpg123_handle, @"type": c_int, value: [*c]c_long, fvalue: [*c]f64) c_int;
pub const MPG123_FEATURE_ABI_UTF8OPEN: c_int = 0;
pub const MPG123_FEATURE_OUTPUT_8BIT: c_int = 1;
pub const MPG123_FEATURE_OUTPUT_16BIT: c_int = 2;
pub const MPG123_FEATURE_OUTPUT_32BIT: c_int = 3;
pub const MPG123_FEATURE_INDEX: c_int = 4;
pub const MPG123_FEATURE_PARSE_ID3V2: c_int = 5;
pub const MPG123_FEATURE_DECODE_LAYER1: c_int = 6;
pub const MPG123_FEATURE_DECODE_LAYER2: c_int = 7;
pub const MPG123_FEATURE_DECODE_LAYER3: c_int = 8;
pub const MPG123_FEATURE_DECODE_ACCURATE: c_int = 9;
pub const MPG123_FEATURE_DECODE_DOWNSAMPLE: c_int = 10;
pub const MPG123_FEATURE_DECODE_NTOM: c_int = 11;
pub const MPG123_FEATURE_PARSE_ICY: c_int = 12;
pub const MPG123_FEATURE_TIMEOUT_READ: c_int = 13;
pub const MPG123_FEATURE_EQUALIZER: c_int = 14;
pub const MPG123_FEATURE_MOREINFO: c_int = 15;
pub const MPG123_FEATURE_OUTPUT_FLOAT32: c_int = 16;
pub const MPG123_FEATURE_OUTPUT_FLOAT64: c_int = 17;
pub const enum_mpg123_feature_set = c_uint;
pub extern fn mpg123_feature2(key: c_int) c_int;
...
pub const MPG123_BAD_OUTFORMAT: c_int = 1;
pub const MPG123_BAD_CHANNEL: c_int = 2;
pub const MPG123_BAD_RATE: c_int = 3;
pub const MPG123_ERR_16TO8TABLE: c_int = 4;
pub const MPG123_BAD_PARAM: c_int = 5;
pub const MPG123_BAD_BUFFER: c_int = 6;
pub const MPG123_OUT_OF_MEM: c_int = 7;
pub const MPG123_NOT_INITIALIZED: c_int = 8;
pub const MPG123_BAD_DECODER: c_int = 9;
pub const MPG123_BAD_HANDLE: c_int = 10;
pub const MPG123_NO_BUFFERS: c_int = 11;
pub const MPG123_BAD_RVA: c_int = 12;
pub const MPG123_NO_GAPLESS: c_int = 13;
pub const MPG123_NO_SPACE: c_int = 14;
pub const MPG123_BAD_TYPES: c_int = 15;
pub const MPG123_BAD_BAND: c_int = 16;
pub const MPG123_ERR_NULL: c_int = 17;
pub const MPG123_ERR_READER: c_int = 18;
pub const MPG123_NO_SEEK_FROM_END: c_int = 19;
pub const MPG123_BAD_WHENCE: c_int = 20;
pub const MPG123_NO_TIMEOUT: c_int = 21;
pub const MPG123_BAD_FILE: c_int = 22;
pub const MPG123_NO_SEEK: c_int = 23;
pub const MPG123_NO_READER: c_int = 24;
pub const MPG123_BAD_PARS: c_int = 25;
pub const MPG123_BAD_INDEX_PAR: c_int = 26;
pub const MPG123_OUT_OF_SYNC: c_int = 27;
pub const MPG123_RESYNC_FAIL: c_int = 28;
pub const MPG123_NO_8BIT: c_int = 29;
pub const MPG123_BAD_ALIGN: c_int = 30;
pub const MPG123_NULL_BUFFER: c_int = 31;
pub const MPG123_NO_RELSEEK: c_int = 32;
pub const MPG123_NULL_POINTER: c_int = 33;
pub const MPG123_BAD_KEY: c_int = 34;
pub const MPG123_NO_INDEX: c_int = 35;
pub const MPG123_INDEX_FAIL: c_int = 36;
pub const MPG123_BAD_DECODER_SETUP: c_int = 37;
pub const MPG123_MISSING_FEATURE: c_int = 38;
pub const MPG123_BAD_VALUE: c_int = 39;
pub const MPG123_LSEEK_FAILED: c_int = 40;
pub const MPG123_BAD_CUSTOM_IO: c_int = 41;
pub const MPG123_LFS_OVERFLOW: c_int = 42;
pub const MPG123_INT_OVERFLOW: c_int = 43;
pub const MPG123_BAD_FLOAT: c_int = 44;
pub const enum_mpg123_errors = c_int;
...
pub extern fn mpg123_decoders() [*c][*c]const u8;
pub extern fn mpg123_supported_decoders() [*c][*c]const u8;
pub extern fn mpg123_decoder(mh: ?*mpg123_handle, decoder_name: [*c]const u8) c_int;
pub extern fn mpg123_current_decoder(mh: ?*mpg123_handle) [*c]const u8;
pub const MPG123_MONO: c_int = 1;
pub const MPG123_STEREO: c_int = 2;
pub const enum_mpg123_channelcount = c_uint;
pub extern fn mpg123_rates(list: [*c][*c]const c_long, number: [*c]usize) void;
pub extern fn mpg123_encodings(list: [*c][*c]const c_int, number: [*c]usize) void;
pub extern fn mpg123_encsize(encoding: c_int) c_int;
pub extern fn mpg123_format_none(mh: ?*mpg123_handle) c_int;
pub extern fn mpg123_format_all(mh: ?*mpg123_handle) c_int;
pub extern fn mpg123_format(mh: ?*mpg123_handle, rate: c_long, channels: c_int, encodings: c_int) c_int;
pub extern fn mpg123_format2(mh: ?*mpg123_handle, rate: c_long, channels: c_int, encodings: c_int) c_int;
pub extern fn mpg123_format_support(mh: ?*mpg123_handle, rate: c_long, encoding: c_int) c_int;
pub extern fn mpg123_getformat(mh: ?*mpg123_handle, rate: [*c]c_long, channels: [*c]c_int, encoding: [*c]c_int) c_int;
pub extern fn mpg123_getformat2(mh: ?*mpg123_handle, rate: [*c]c_long, channels: [*c]c_int, encoding: [*c]c_int, clear_flag: c_int) c_int;
pub extern fn mpg123_open_fixed(mh: ?*mpg123_handle, path: [*c]const u8, channels: c_int, encoding: c_int) c_int;
pub extern fn mpg123_open(mh: ?*mpg123_handle, path: [*c]const u8) c_int;
pub extern fn mpg123_open_fd(mh: ?*mpg123_handle, fd: c_int) c_int;
pub extern fn mpg123_open_handle(mh: ?*mpg123_handle, iohandle: ?*anyopaque) c_int;
pub extern fn mpg123_open_feed(mh: ?*mpg123_handle) c_int;
pub extern fn mpg123_close(mh: ?*mpg123_handle) c_int;
pub extern fn mpg123_read(mh: ?*mpg123_handle, outmemory: ?*anyopaque, outmemsize: usize, done: [*c]usize) c_int;
pub extern fn mpg123_feed(mh: ?*mpg123_handle, in: [*c]const u8, size: usize) c_int;
pub extern fn mpg123_decode(mh: ?*mpg123_handle, inmemory: [*c]const u8, inmemsize: usize, outmemory: ?*anyopaque, outmemsize: usize, done: [*c]usize) c_int;
pub extern fn mpg123_decode_frame(mh: ?*mpg123_handle, num: [*c]off_t, audio: [*c][*c]u8, bytes: [*c]usize) c_int;
pub extern fn mpg123_framebyframe_decode(mh: ?*mpg123_handle, num: [*c]off_t, audio: [*c][*c]u8, bytes: [*c]usize) c_int;
pub extern fn mpg123_decode_frame64(mh: ?*mpg123_handle, num: [*c]i64, audio: [*c][*c]u8, bytes: [*c]usize) c_int;
pub extern fn mpg123_framebyframe_decode64(mh: ?*mpg123_handle, num: [*c]i64, audio: [*c][*c]u8, bytes: [*c]usize) c_int;
pub extern fn mpg123_framebyframe_next(mh: ?*mpg123_handle) c_int;
pub extern fn mpg123_framedata(mh: ?*mpg123_handle, header: [*c]c_ulong, bodydata: [*c][*c]u8, bodybytes: [*c]usize) c_int;
pub extern fn mpg123_framepos(mh: ?*mpg123_handle) off_t;
pub extern fn mpg123_framepos64(mh: ?*mpg123_handle) i64;
pub extern fn mpg123_tell(mh: ?*mpg123_handle) off_t;
pub extern fn mpg123_tell64(mh: ?*mpg123_handle) i64;
pub extern fn mpg123_tellframe(mh: ?*mpg123_handle) off_t;
pub extern fn mpg123_tellframe64(mh: ?*mpg123_handle) i64;
pub extern fn mpg123_tell_stream(mh: ?*mpg123_handle) off_t;
pub extern fn mpg123_tell_stream64(mh: ?*mpg123_handle) i64;
pub extern fn mpg123_seek(mh: ?*mpg123_handle, sampleoff: off_t, whence: c_int) off_t;
pub extern fn mpg123_seek64(mh: ?*mpg123_handle, sampleoff: i64, whence: c_int) i64;
pub extern fn mpg123_feedseek(mh: ?*mpg123_handle, sampleoff: off_t, whence: c_int, input_offset: [*c]off_t) off_t;
pub extern fn mpg123_feedseek64(mh: ?*mpg123_handle, sampleoff: i64, whence: c_int, input_offset: [*c]i64) i64;
pub extern fn mpg123_seek_frame(mh: ?*mpg123_handle, frameoff: off_t, whence: c_int) off_t;
pub extern fn mpg123_seek_frame64(mh: ?*mpg123_handle, frameoff: i64, whence: c_int) i64;
...
pub extern fn mpg123_timeframe64(mh: ?*mpg123_handle, sec: f64) i64;
pub extern fn mpg123_index64(mh: ?*mpg123_handle, offsets: [*c][*c]i64, step: [*c]i64, fill: [*c]usize) c_int;
pub extern fn mpg123_set_index(mh: ?*mpg123_handle, offsets: [*c]off_t, step: off_t, fill: usize) c_int;
pub extern fn mpg123_set_index64(mh: ?*mpg123_handle, offsets: [*c]i64, step: i64, fill: usize) c_int;
pub extern fn mpg123_position(mh: ?*mpg123_handle, INT123_frame_offset: off_t, buffered_bytes: off_t, current_frame: [*c]off_t, frames_left: [*c]off_t, current_seconds: [*c]f64, seconds_left: [*c]f64) c_int;
pub const MPG123_LEFT: c_int = 1;
pub const MPG123_RIGHT: c_int = 2;
pub const MPG123_LR: c_int = 3;
pub const enum_mpg123_channels = c_uint;
pub extern fn mpg123_eq2(mh: ?*mpg123_handle, channel: c_int, band: c_int, val: f64) c_int;
pub extern fn mpg123_eq_bands(mh: ?*mpg123_handle, channel: c_int, a: c_int, b: c_int, factor: f64) c_int;
pub extern fn mpg123_eq_change(mh: ?*mpg123_handle, channel: c_int, a: c_int, b: c_int, db: f64) c_int;
pub extern fn mpg123_geteq2(mh: ?*mpg123_handle, channel: c_int, band: c_int) f64;
...
pub extern fn mpg123_volume_change_db(mh: ?*mpg123_handle, db: f64) c_int;
pub extern fn mpg123_getvolume(mh: ?*mpg123_handle, base: [*c]f64, really: [*c]f64, rva_db: [*c]f64) c_int;
pub const MPG123_CBR: c_int = 0;
pub const MPG123_VBR: c_int = 1;
pub const MPG123_ABR: c_int = 2;
pub const enum_mpg123_vbr = c_uint;
pub const MPG123_1_0: c_int = 0;
pub const MPG123_2_0: c_int = 1;
pub const MPG123_2_5: c_int = 2;
pub const enum_mpg123_version = c_uint;
pub const MPG123_M_STEREO: c_int = 0;
pub const MPG123_M_JOINT: c_int = 1;
pub const MPG123_M_DUAL: c_int = 2;
pub const MPG123_M_MONO: c_int = 3;
pub const enum_mpg123_mode = c_uint;
pub const MPG123_CRC: c_int = 1;
pub const MPG123_COPYRIGHT: c_int = 2;
pub const MPG123_PRIVATE: c_int = 4;
pub const MPG123_ORIGINAL: c_int = 8;
pub const enum_mpg123_flags = c_uint;
pub const struct_mpg123_frameinfo2 = extern struct {
    version: c_int,
    layer: c_int,
    rate: c_long,
    mode: c_int,
...
pub const struct_mpg123_moreinfo = extern struct {
    xr: [2][2][576]f64,
    sfb: [2][2][22]f64,
    sfb_s: [2][2][39]f64,
    qss: [2][2]c_int,
    big_values: [2][2]c_int,
    sub_gain: [2][2][3]c_int,
    scalefac_scale: [2][2]c_int,
    preflag: [2][2]c_int,
    blocktype: [2][2]c_int,
    mixed: [2][2]c_int,
    mainbits: [2][2]c_int,
...
pub extern fn mpg123_info2(mh: ?*mpg123_handle, mi: [*c]struct_mpg123_frameinfo2) c_int;
pub extern fn mpg123_set_moreinfo(mh: ?*mpg123_handle, mi: [*c]struct_mpg123_moreinfo) c_int;
...
pub extern fn mpg123_framelength64(mh: ?*mpg123_handle) i64;
pub extern fn mpg123_length64(mh: ?*mpg123_handle) i64;
pub extern fn mpg123_set_filesize64(mh: ?*mpg123_handle, size: i64) c_int;
...
pub const MPG123_ACCURATE: c_int = 1;
pub const MPG123_BUFFERFILL: c_int = 2;
pub const MPG123_FRANKENSTEIN: c_int = 3;
pub const MPG123_FRESH_DECODER: c_int = 4;
pub const MPG123_ENC_DELAY: c_int = 5;
pub const MPG123_ENC_PADDING: c_int = 6;
pub const MPG123_DEC_DELAY: c_int = 7;
pub const enum_mpg123_state = c_uint;
pub extern fn mpg123_getstate2(mh: ?*mpg123_handle, key: c_int, val: [*c]c_long, fval: [*c]f64) c_int;
pub const mpg123_string = extern struct {
    p: [*c]u8,
    size: usize,
    fill: usize,
};
pub extern fn mpg123_new_string(val: [*c]const u8) [*c]mpg123_string;
pub extern fn mpg123_delete_string(sb: [*c]mpg123_string) void;
...
pub extern fn mpg123_move_string(from: [*c]mpg123_string, to: [*c]mpg123_string) c_int;
...
pub extern fn mpg123_same_string(a: [*c]mpg123_string, b: [*c]mpg123_string) c_int;
pub const mpg123_text_unknown: c_int = 0;
pub const mpg123_text_utf8: c_int = 1;
pub const mpg123_text_latin1: c_int = 2;
pub const mpg123_text_icy: c_int = 3;
pub const mpg123_text_cp1252: c_int = 4;
pub const mpg123_text_utf16: c_int = 5;
pub const mpg123_text_utf16bom: c_int = 6;
pub const mpg123_text_utf16be: c_int = 7;
pub const mpg123_text_max: c_int = 7;
pub const enum_mpg123_text_encoding = c_uint;
pub const mpg123_id3_latin1: c_int = 0;
pub const mpg123_id3_utf16bom: c_int = 1;
pub const mpg123_id3_utf16be: c_int = 2;
pub const mpg123_id3_utf8: c_int = 3;
pub const mpg123_id3_enc_max: c_int = 3;
pub const enum_mpg123_id3_enc = c_uint;
pub extern fn mpg123_enc_from_id3_2(id3_enc_byte: u8) c_int;
pub extern fn mpg123_store_utf8_2(sb: [*c]mpg123_string, enc: c_int, source: [*c]const u8, source_size: usize) c_int;
pub const mpg123_text = extern struct {
    lang: [3]u8,
    id: [4]u8,
    description: mpg123_string,
    text: mpg123_string,
};
pub const mpg123_id3_pic_other: c_int = 0;
pub const mpg123_id3_pic_icon: c_int = 1;
pub const mpg123_id3_pic_other_icon: c_int = 2;
pub const mpg123_id3_pic_front_cover: c_int = 3;
pub const mpg123_id3_pic_back_cover: c_int = 4;
pub const mpg123_id3_pic_leaflet: c_int = 5;
pub const mpg123_id3_pic_media: c_int = 6;
pub const mpg123_id3_pic_lead: c_int = 7;
pub const mpg123_id3_pic_artist: c_int = 8;
pub const mpg123_id3_pic_conductor: c_int = 9;
pub const mpg123_id3_pic_orchestra: c_int = 10;
pub const mpg123_id3_pic_composer: c_int = 11;
pub const mpg123_id3_pic_lyricist: c_int = 12;
pub const mpg123_id3_pic_location: c_int = 13;
pub const mpg123_id3_pic_recording: c_int = 14;
pub const mpg123_id3_pic_performance: c_int = 15;
pub const mpg123_id3_pic_video: c_int = 16;
pub const mpg123_id3_pic_fish: c_int = 17;
pub const mpg123_id3_pic_illustration: c_int = 18;
pub const mpg123_id3_pic_artist_logo: c_int = 19;
pub const mpg123_id3_pic_publisher_logo: c_int = 20;
pub const enum_mpg123_id3_pic_type = c_uint;
pub const mpg123_picture = extern struct {
    type: u8,
    description: mpg123_string,
...
pub const mpg123_id3v2 = extern struct {
    version: u8,
...
pub const mpg123_id3v1 = extern struct {
    tag: [3]u8,
    title: [30]u8,
    artist: [30]u8,
    album: [30]u8,
...
pub extern fn mpg123_id3_raw(mh: ?*mpg123_handle, v1: [*c][*c]u8, v1_size: [*c]usize, v2: [*c][*c]u8, v2_size: [*c]usize) c_int;
...
pub extern fn mpg123_fmt2(mp: ?*mpg123_pars, rate: c_long, channels: c_int, encodings: c_int) c_int;
pub extern fn mpg123_fmt_support(mp: ?*mpg123_pars, rate: c_long, encoding: c_int) c_int;
pub extern fn mpg123_par2(mp: ?*mpg123_pars, @"type": c_int, value: c_long, fvalue: f64) c_int;
pub extern fn mpg123_getpar2(mp: ?*mpg123_pars, @"type": c_int, value: [*c]c_long, fvalue: [*c]f64) c_int;
pub extern fn mpg123_replace_buffer(mh: ?*mpg123_handle, data: ?*anyopaque, size: usize) c_int;
pub extern fn mpg123_outblock(mh: ?*mpg123_handle) usize;
pub extern fn mpg123_replace_reader(mh: ?*mpg123_handle, r_read: ?*const fn (c_int, ?*anyopaque, usize) callconv(.C) mpg123_ssize_t, r_lseek: ?*const fn (c_int, off_t, c_int) callconv(.C) off_t) c_int;
pub extern fn mpg123_replace_reader_handle(mh: ?*mpg123_handle, r_read: ?*const fn (?*anyopaque, ?*anyopaque, usize) callconv(.C) mpg123_ssize_t, r_lseek: ?*const fn (?*anyopaque, off_t, c_int) callconv(.C) off_t, cleanup: ?*const fn (?*anyopaque) callconv(.C) void) c_int;
pub extern fn mpg123_reader64(mh: ?*mpg123_handle, r_read: ?*const fn (?*anyopaque, ?*anyopaque, usize, [*c]usize) callconv(.C) c_int, r_lseek: ?*const fn (?*anyopaque, i64, c_int) callconv(.C) i64, cleanup: ?*const fn (?*anyopaque) callconv(.C) void) c_int;
...
pub const __OS_TYPES_H__ = "";
pub const AO_TYPE_LIVE = @as(c_int, 1);
pub const AO_TYPE_FILE = @as(c_int, 2);
pub const AO_ENODRIVER = @as(c_int, 1);
pub const AO_ENOTFILE = @as(c_int, 2);
pub const AO_ENOTLIVE = @as(c_int, 3);
pub const AO_EBADOPTION = @as(c_int, 4);
pub const AO_EOPENDEVICE = @as(c_int, 5);
pub const AO_EOPENFILE = @as(c_int, 6);
pub const AO_EFILEEXISTS = @as(c_int, 7);
pub const AO_EBADFORMAT = @as(c_int, 8);
pub const AO_EFAIL = @as(c_int, 100);
pub const AO_FMT_LITTLE = @as(c_int, 1);
pub const AO_FMT_BIG = @as(c_int, 2);
pub const AO_FMT_NATIVE = @as(c_int, 4);
pub const MPG123_LIB_H = "";
pub const MPG123_ENC_H = "";
pub inline fn MPG123_SAMPLESIZE(enc: anytype) @TypeOf(if (enc < @as(c_int, 1)) @as(c_int, 0) else if (enc & MPG123_ENC_8) @as(c_int, 1) else if (enc & MPG123_ENC_16) @as(c_int, 2) else if (enc & MPG123_ENC_24) @as(c_int, 3) else if (((enc & MPG123_ENC_32) != 0) or (enc == MPG123_ENC_FLOAT_32)) @as(c_int, 4) else if (enc == MPG123_ENC_FLOAT_64) @as(c_int, 8) else @as(c_int, 0)) {
    return if (enc < @as(c_int, 1)) @as(c_int, 0) else if (enc & MPG123_ENC_8) @as(c_int, 1) else if (enc & MPG123_ENC_16) @as(c_int, 2) else if (enc & MPG123_ENC_24) @as(c_int, 3) else if (((enc & MPG123_ENC_32) != 0) or (enc == MPG123_ENC_FLOAT_32)) @as(c_int, 4) else if (enc == MPG123_ENC_FLOAT_64) @as(c_int, 8) else @as(c_int, 0);
}
pub inline fn MPG123_ZEROSAMPLE(enc: anytype, siz: anytype, off: anytype) @TypeOf(if (enc == MPG123_ENC_ULAW_8) if (off == @as(c_int, 0)) @as(c_int, 0xff) else @as(c_int, 0x00) else if (enc == MPG123_ENC_ALAW_8) if (off == @as(c_int, 0)) @as(c_int, 0xd5) else @as(c_int, 0x00) else if (((enc & (MPG123_ENC_SIGNED | MPG123_ENC_FLOAT)) != 0) or (siz != (off + @as(c_int, 1)))) @as(c_int, 0x00) else @as(c_int, 0x80)) {
    return if (enc == MPG123_ENC_ULAW_8) if (off == @as(c_int, 0)) @as(c_int, 0xff) else @as(c_int, 0x00) else if (enc == MPG123_ENC_ALAW_8) if (off == @as(c_int, 0)) @as(c_int, 0xd5) else @as(c_int, 0x00) else if (((enc & (MPG123_ENC_SIGNED | MPG123_ENC_FLOAT)) != 0) or (siz != (off + @as(c_int, 1)))) @as(c_int, 0x00) else @as(c_int, 0x80);
}
pub const MPG123_API_VERSION = @as(c_int, 48);
pub const MPG123_PATCHLEVEL = @as(c_int, 0);
pub const MPG123_EXPORT = "";
pub const mpg123_param = mpg123_param2;
pub const mpg123_getparam = mpg123_getparam2;
pub const mpg123_feature = mpg123_feature2;
pub const mpg123_eq = mpg123_eq2;
pub const mpg123_geteq = mpg123_geteq2;
pub const mpg123_frameinfo = mpg123_frameinfo2;
pub const mpg123_info = mpg123_info2;
pub const mpg123_getstate = mpg123_getstate2;
pub const mpg123_enc_from_id3 = mpg123_enc_from_id3_2;
pub const mpg123_store_utf8 = mpg123_store_utf8_2;
pub const mpg123_par = mpg123_par2;
pub const mpg123_getpar = mpg123_getpar2;
...
pub const MPG123_ID3 = @as(c_int, 0x3);
pub const MPG123_NEW_ID3 = @as(c_int, 0x1);
pub const MPG123_ICY = @as(c_int, 0xc);
pub const MPG123_NEW_ICY = @as(c_int, 0x4);
...
pub const mpg123_frameinfo2 = struct_mpg123_frameinfo2;
pub const mpg123_moreinfo = struct_mpg123_moreinfo;
